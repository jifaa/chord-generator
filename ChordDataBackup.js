...
const CHROMATIC_TO_CIRCLE_MAJOR = {
    0: 0,   // C
    1: 7,   // C#/Db
    2: 2,   // D
    3: 9,   // D#/Eb
...
const CIRCLE_MINOR_ORDER = ['A', 'E', 'B', 'Gb', 'Db', 'Ab', 'Eb', 'Bb', 'F', 'C', 'G', 'D'];

const CHROMATIC_TO_CIRCLE_MINOR = {};
 ...
 * @param {string} note - Nama nada (C, D, E, dll)
 * @param {string} type - 'major' atau 'minor'
 * @returns {number} Posisi di circle (0-11)
 */
function getCirclePosition(note, type = 'major') {
...
/**
 * Menghitung bobot transisi berdasarkan Circle of Fifths
 * @param {string} fromNote - Nada asal
 * @param {string} fromType - Tipe chord asal ('major' atau 'minor')
 * @param {string} toNote - Nada tujuan
 * @param {string} toType - Tipe chord tujuan ('major' atau 'minor')
 * @returns {number} Bobot (0.29 - 1.00)
 */
function getCircleWeight(fromNote, fromType, toNote, toType) {
...
/**
 * Mengkonversi bobot Circle of Fifths ke persentase untuk array weights
 * @param {Array} weights - Array bobot mentah
 * @returns {Array} Array bobot dalam persentase (total ~100)
 */
