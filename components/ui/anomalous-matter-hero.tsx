...
export function GenerativeArtScene() {
  ...
  useEffect(() => {
    ...
    // Project color palette - violet/cyan theme
    const primaryColor = new THREE.Color('#7c5cfc'); // violet
    const secondaryColor = new THREE.Color('#22d3ee'); // cyan
    const accentColor = new THREE.Color('#f5a524'); // amber
    ...
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
                ...
                void main() {
                    ...
                    vec3 baseColor = mix(color, secondaryColor, colorMix * 0.3);
                    ...
                    float accent = pow(max(dot(reflect(-lightDir, normal), vec3(0.0, 0.0, 1.0)), 0.0), 16.0);

                    vec3 finalColor = baseColor * diffuse + baseColor * fresnel * 0.5 + accentColor * accent * 0.3;
